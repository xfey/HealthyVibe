...
```text
dist/HealthyVibe-1.0.2.zip
dist/HealthyVibe-1.0.2.zip.sha256
dist/healthyvibe.rb
```
...
```bash
HEALTHYVIBE_RELEASE_URL="https://github.com/xfey/HealthyVibe/releases/download/v1.0.2/HealthyVibe-1.0.2.zip" make package
```
